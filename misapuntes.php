...
<?php include './php/php_eliminar_apunte.php'; ?>
<?php include './php/modificar_apuntes.php'; ?>
...
<html lang="es">
    ...
    <body>       
        <div class="modal fade" id="myModalSubeApuntes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">Subir Apuntes</h4>
                    </div>
                    <div class="modal-body" >
                        <form method="post" id="subirApunteForm" name="subirApunteForm" action="resultado_subir_apuntes.php" enctype="multipart/form-data">
                            <div class="row">
                                <label class="col-xs-2 col-xs-offset-1 text-right">T&iacute;tulo</label>
                                <input type="text" id="inputTitulo" name="inputTitulo" class="col-xs-6 text-center col-xs-offset-1">
                            </div>
                            <br>
                            <div class="row">
                                <label class="col-xs-2 col-xs-offset-1 text-right">Descripci&oacute;n</label>
                                <input type="text" id="inputDescripción" name="inputDescripcion" class="col-xs-6 text-center col-xs-offset-1">
                            </div>
                            <br>
                            <div class="row">
                                <label class="col-xs-2 col-xs-offset-1 text-right">Fichero</label>
                                <input id="inputArchivo" name="inputArchivo" type="file" class="btn col-xs-8 col-xs-offset-1">
                            </div>
                            <input type="hidden" id="haydato" name="haydato" value="haydato">
                            <br>
                            <div class="row">
                                <button class="btn btn-warning btn-lg" style="width: 100%;">Subir apuntes</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php include './php/php_misapuntes.php'; ?>  
                            <?php include './php/modificar_apuntes.php'; ?>                        
