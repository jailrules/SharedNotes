...
<!DOCTYPE html>
<?php include "./php/subir_apunte.php";

//Resultados subir apuntes

if(isset($sihaydato)==false){

    header('Location: misapuntes.php');
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <BR>
                            <?php if($error_2<>''){
                                echo" <div class=\"alert alert-danger\"><strong>ERROR: </strong>$error_2</div>";

                            }else{
                            echo "<div class=\"alert alert-success\"><strong>¡Bien Hecho! </strong>Gracias por subir apuntes, tendrás que esperar a que el apunte sea aprobado por un revisor para que se visualice en la web</div>";

                            }
                            ?>
                              <BR>
                              <button type="submit" class="btn btn-danger" onclick = "javascript:window.location = 'misapuntes.php'">Volver a mis apuntes</button>
                            <BR>
